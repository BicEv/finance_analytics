...
public class AccountServiceTest {
        ...
        void testGetUserAccounts_success() {
                ...
                List<AccountDto> result = accountService.getUserAccounts();

                assertEquals(2, result.size());
                assertEquals(acc1.getName(), result.get(0).name());
                assertEquals(acc2.getName(), result.get(1).name());
        ...
        void testGetAccountById_success() {
                ...
                assertEquals("Wallet", result.name());
        }
        ...
        void testUpdateAccount_success() {
                ...
                AccountDto result = accountService.updateAccount(id, "NewName");
