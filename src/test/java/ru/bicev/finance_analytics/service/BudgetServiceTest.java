...
public class BudgetServiceTest {
        ...
        void testGetAllBudgetsForUser_success() {
                ...
                List<BudgetDto> result = budgetService.getAllBudgetsForUser();
        ...
        void testGetBudgetsForMonth_success() {
                ...
                Budget b = Budget.builder().id(UUID.randomUUID()).month(month).category(category).user(user).build();

                when(budgetRepository.findByUserIdAndMonth(user.getId(), month))
                                .thenReturn(List.of(b));

                List<BudgetDto> result = budgetService.getBudgetsForMonth(month);
