...
public class AnalyticsServiceTest {
    ...
    void getExpensesByCategory() {
        ...
        assertEquals(tr3.getAmount(), result.get("Salary"));
    ...
    void testGetTopCategories() {
        ...
        assertEquals("Salary", result.get(0).getKey());
        assertEquals("Food", result.get(1).getKey());
        assertEquals("Entertainment", result.get(2).getKey());
    }
    ...
    void testGetExpensesByAccount() {
        ...
        Map<String, BigDecimal> result = analyticsService.getExpensesByAccount(accountId, month);
    ...
    void testGetDailyExpenses() {
        ...
        assertEquals(tr3.getAmount(), result.get(tr3.getDate()));
    ...
    void testGetMonthlyExpenses() {
        ...
        Map<String, BigDecimal> result = analyticsService.getMonthlyExpenses(accountId, month);
    ...
    void testGetCategoryBudgetStatus() {
        ...
        assertEquals(
                tr1.getAmount().add(tr2.getAmount()).multiply(BigDecimal.valueOf(100).divide(b1.getLimitAmount()))
    ...
    void testGetUpcomingRecurringPayments() {
        when(recurringTransactionRepository.findAllByUserIdAndActiveAndNextExecutionDateGreaterThan(userId, true,
