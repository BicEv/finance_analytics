...
public record RecurringTransactionRequest(@NotNull(message = "Category id cannot be null") UUID categoryId,
                ...
                @NotNull(message = "Next execution day cannot be null") LocalDate nextExecutionDate, String description,
                boolean isActive) {
